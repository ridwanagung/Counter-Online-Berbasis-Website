        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="about">
                    <h4>Team Info</h4><br>
                     <div class="news_left">
							<img src="images/img1.jpg" alt="" title="" style="border:0px;width:150px;height:150px; float: left; padding-right: 15px; padding-bottom: 10px;"/>
							<p><a href="info1.php">Hardyan Alief A | Manager.</a><br />
								Aktifis yang bertanggung jawab, selalu memberi semangat kepada Team, Keahliannya dibidang makalah dan karya ilmiyah sangatlah...  </p><br>
