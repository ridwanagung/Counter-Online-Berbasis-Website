        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="about">
                    <h4>Team Info</h4><br>
                     <div class="news_left">
							<img src="images/img4.jpg" alt="" title="" style="border:0px;width:150px;height:150px; float: left; padding-right: 15px; padding-bottom: 10px;"/>
							<p><a href="info4.php"> Wildan Atohilah | Editor. </a><br />
								Dia salah satu editor yang handal dalam Team ini, keahliannya dalam mengotak-atik tampilan sangat memudahkan dalam...</p><br>
