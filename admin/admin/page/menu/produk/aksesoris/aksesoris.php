              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <a href="dasbord.php?page=tambah_aksesoris"><button class="btn btn-primary" type="Button">Tambah</button></a>
                        </header>
...
while($tampil=mysql_fetch_array($result)){
                              $j++
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                      <a class="btn btn-danger" href="dasbord.php?page=hapus_aksesoris&id=<?php echo $tampil['id_aksesoris']; ?>"><i class="icon_close_alt2"></i></a>
                                      <a class="btn btn-primary" href="dasbord.php?page=edit_aksesoris&id=<?php echo $tampil['id_aksesoris']; ?>"><i class="icon_bag_alt" title="Edit"></i></a>                                               
                                        </div>
                                    </td>
                                </tr>
                                <?php };?> 
