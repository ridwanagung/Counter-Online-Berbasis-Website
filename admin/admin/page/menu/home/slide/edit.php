    ...
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="dasbord.php?page=home_admin">Slide</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    $id = $_GET['id'];
                    $query = "SELECT * FROM tb_slide WHERE id_slide=$id";
                    $data = mysql_query($query);
                    $tampil = mysql_fetch_array($data);
                    ?>
                    <div class="panel-body">
                        <div class="form">
                            <form method="post" action="dasbord.php?page=proses_edit_slide" enctype="multipart/form-data" >
                                <input type="hidden" value="<?php echo $id ?>" name="id_slide">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <td><?php echo '<img src="aset/images/slide/'.$tampil['nama_file'].'" width="200" />'; ?></td>
                                    </div>
                                </div>
                                <div class="form-group">
